...
describe('selectHomeRanking', () => {
  it('includes every ex aequo at rank 3 and not the rest', () => {
    const players = [
      player({ id: '1', pseudo: 'A', points: 9, exactScores: 3 }),
      player({ id: '2', pseudo: 'B', points: 6, exactScores: 2 }),
      player({ id: '3', pseudo: 'C', points: 3, exactScores: 1 }),
      player({ id: '4', pseudo: 'D', points: 3, exactScores: 1 }),
      player({ id: '5', pseudo: 'E', points: 0, exactScores: 0 }),
    ]
  ...
  it('appends the connected player when outside top ranks', () => {
    const players = [
      player({ id: '1', pseudo: 'A', points: 9 }),
      player({ id: '2', pseudo: 'B', points: 6 }),
      player({ id: '3', pseudo: 'C', points: 3 }),
      player({ id: '5', pseudo: 'E', points: 0 }),
    ]
    const ranks = getCompetitionRanks(players)
...
describe('ranking migration and UI wiring', () => {
  ...
  it('loads participation in a single RPC per selected round', () => {
    assert.match(rankingPage, /fetchRoundParticipation\(\s*sessionToken!,\s*selectedRound!/)
